...
public class GooglePage extends BaseClass {  
	...
	/*
	 * WebElements of Google Search page and result page
	 */
	...
	/*
	 * Getters for webElements of Google Search page and result page
	 */
	...
	/*
	 * Method to google the phrase:"today's ipl match"
	 */
	...
	/*
	 * Method to print the names and scores of the teams playing
	 */
